...
class ValidateResourceContainer {
    ...
    fun validateChecking(value: Checking): Boolean {
        return value.isNotNull()
                .and(value.checkingLevel.isNotEmpty())
    ...
    fun validateProjects(value: List<Project>): Boolean {
        return value.isNotEmpty()
                .and(value.filter { it.isNotNull() }.size == value.size)
                .and(value.filter { it.title.isNotEmpty()
    ...
    fun validate(rc: ResourceContainer): Boolean {
        return validateConformsTo(rc.manifest.dublinCore.conformsTo)
                ...
                .and(validateLanguage(rc.manifest.dublinCore.language)
...
fun Language.isNotNull(): Boolean {
    return this != null
}

fun Checking.isNotNull(): Boolean {
    return this != null
}

fun Source.isNotNull(): Boolean {
    return this != null
}

fun Project.isNotNull(): Boolean {
    return this != null
}